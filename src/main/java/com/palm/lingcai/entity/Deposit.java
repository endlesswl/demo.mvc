...
public class Deposit
{
	...
	public static final String	ALIAS_RATE			= "清算汇率";
	public static final String	ALIAS_ACTUALMONEY	= "实际到帐金额";
	public static final String	ALIAS_ORDERID		= "订单号";
	public static final String	ALIAS_TRADENO		= "第三方交易流水号";
	public static final String	ALIAS_METHOD		= "充值方式";
	public static final String	ALIAS_METHODEXT		= "充值方式扩展";
	...
	public static final String	ALIAS_SALT			= "校验标识位";
	...
	/**
	 * 充值方式，如支付宝、银联还是其他, 0(支付宝)  ,1(银联) ，2(微信财富通)
	 */
	...
	/**
	 * 过期时间 单位m(分钟),m-分钟,h-小时,d-天,取值范围:1m~15d (1m~21600m)
	 */
